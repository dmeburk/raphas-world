...
function initGuestbookWidget() {
  ...
  const DEFAULT_FAMILY_MESSAGES = [
    ...
    },
    {
      ...
      avatar: '👧',
      badge: 'SISSY 👾',
      message: "Rafa-pasta! You are the absolute best partner-in-crime ever! Let's play Roblox together later! 🎮👾😜",
      glow: false,
      timestamp: 'STAR DATE 2026.06.29',
      type: 'family-sissy',
      isCustom: false
    },
    {
      ...
      avatar: '🤙',
      badge: 'BRAH 🤙',
      message: "Yo, Rapha! Look at me rocking the mega-chair! Keep being the absolute coolest master of Minecraft! High five! 🤙🔥🎮",
      glow: false,
      timestamp: 'STAR DATE 2026.06.29',
      type: 'family-brah',
      isCustom: false
